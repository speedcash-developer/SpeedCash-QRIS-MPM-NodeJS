/**
 * API Merchant Detail
 * Service ini digunakan untuk meilhat detail data dari merchant
 * 
 * Referensi:
 * API Documentation: https://qris-mpm-docs.speedcash.co.id/docs/payments/qris-mpm/Registrasi/Merchant%20Detail 
 */
